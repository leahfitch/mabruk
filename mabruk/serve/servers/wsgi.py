...
class WSGIServer(Server):
    ...
    def __init__(self, sock, app=None, numthreads=10, server_name=None,
        ...
        self.bind_addr = sock.getsockname()
        
        
    def setup(self):
        self.requests = ThreadPool(self, min=self.min or 1, max=self.max)
        wsgi_app = self.get_app()
        
        if not wsgi_app:
            raise Exception, "Expected an app or app list, got '%s'" % wsgi_app
